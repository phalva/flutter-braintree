...
#   s.dependency 'BraintreeDropIn', '9.14.0'
  s.dependency 'Braintree/PayPal', '~> 7.0.0'
  s.dependency 'Braintree/ApplePay', '~> 7.0.0'
  s.dependency 'Braintree/Core', '~> 7.0.0'
  s.dependency 'Braintree/Card', '~> 7.0.0'
  s.dependency 'Braintree/PaymentFlow', '~> 7.0.0'
